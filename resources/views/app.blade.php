...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets_pluginLanding/favicon.ico') }}" />
    ...
    <link href="{{ asset('assets_pluginLanding/css/styles.css') }}" rel="stylesheet" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Gedung Sjafruddin Prawiranegara II, Lantai 7, Jl. Lap. Banteng Timur No.2, RW.4, Ps. Baru,
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/cabin.png') }}"
                                    alt="..." />
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/cake.png') }}"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia
                                    neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/circus.png') }}"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia
                                    neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/game.png') }}"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia
                                    neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/safe.png') }}"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia
                                    neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5"
                                    src="{{ asset('assets_pluginLanding/assets/img/portfolio/submarine.png') }}"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia
                                    neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore
