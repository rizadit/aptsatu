        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="hidden" name="ID_KANTOR" class="form-control ID_KANTOR"
                                                    value="{{ session('user')->ID_USER ?? session()->get('user-data')['kode_organisasi'] }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                {{-- <div class="editor-container"> --}}
                                                    ...
                                                    {{-- <p>Yth. Bapak/Ibu <span class="NAMA-PENGGUNA">[Nama pengguna]</span>
                                                    </p>
                                                    <p><br></p>
                                                    <p>Terima kasih telah mengunjungi Area Pelayanan Terpadu [Nama Kantor].
                                                    </p>
                                                    <p>Berikut kami sampaikan riwayat percakapan dari layanan yang telah
                                                        diberikan.</p>
                                                    <p><br></p>
                                                    <p>Unit Kerja/Perorangan: [Sesuai detail unit kerja]</p>
                                                    <p><br></p>
                                                    <p>Rangkuman Pertanyaan/Permasalahan: [Isian pertanyaan]</p>
                                                    <p><br></p>
                                                    <p>Rangkuman Jawaban: [Isian jawaban]</p>
                                                    <p><br></p>
                                                    <p>Demikian informasi ini kami sampaikan semoga dapat membantu
                                                        Bapak/Ibu.</p>
                                                    <p>Kemudian sebagai bahan evaluasi atas kualitas layanan kami, mohon
                                                        perkenan Bapak/Ibu untuk dapat memberikan feedback atas penyampaian
                                                        jawaban kami.</p>
                                                    <p><br></p>
                                                    <p>Terimakasih telah menghubungi layanan [Nama Kantor] dan selamat
                                                        beraktivitas kembali,</p>
                                                    <p><br></p>
                                                    <p><br></p>
                                                    <p>ttd.</p>
                                                    <p>[Nama Kantor]</p> --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control summernote" id="content" name="content">
                                                    <p>Yth. Bapak/Ibu <span class="NAMA-PENGGUNA">[Nama pengguna]</span></p><p><br></p><p>Terima kasih telah menghubungi layanan [Telepon/Whatsapp].</p><p>Berikut kami sampaikan riwayat percakapan dari layanan yang telah diberikan.</p><p><br></p><p>Unit Kerja/Perorangan: [Sesuai detail unit kerja]</p><p><br></p><p>Rangkuman Pertanyaan/Permasalahan: [Isian pertanyaan]</p><p><br></p><p>Rangkuman Jawaban: [Isian jawaban]</p><p><br></p><p>Demikian informasi ini kami sampaikan semoga dapat membantu Bapak/Ibu.</p><p>Kemudian sebagai bahan evaluasi atas kualitas layanan kami, mohon perkenan Bapak/Ibu untuk dapat memberikan feedback atas penyampaian jawaban kami.</p><p><br></p><p>Terimakasih telah menghubungi layanan [Nama Kantor] dan selamat beraktivitas kembali,</p><p><br></p><p><br></p><p>ttd.</p><p>[Nama Kantor]</p>
                                                </textarea>
                                            </div>
                                        </div>
                                        <hr>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" form="tambahLayananForm">Simpan Data</button>
...
@section('section_js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // var initialHTML = quill.root.innerHTML;

            // // Update textarea content whenever the editor content changes
            ...
            //     var name = $(this).val();
            //     // alert(name);
            //     var updatedHTML = initialHTML.replace(/\[Nama pengguna\]/g, name ? name :
            //         '[Nama pengguna]');
            //     quill.root.innerHTML = updatedHTML;
            //     $('.NAMA-PENGGUNA').text(name ? name : '[Nama pengguna]');
            // });
            // $('.UNITKERJA').on('input', function() {
            //     var name = $(this).val();
            //     // alert(name);
            //     var updatedHTML = initialHTML.replace(/\[Sesuai detail unit kerja]/g, name ? name :
            //         '[Sesuai detail unit kerja]');
            //     quill.root.innerHTML = updatedHTML;
            // });
